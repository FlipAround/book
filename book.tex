...
for online teaching and learning. UTSOnline and CICAround are the two
primary environments for you to familiarise yourself with.
...
\includegraphics{images/Tableaulogo.png}
...
\includegraphics{images/KNIMElogo.png}
...
\includegraphics{images/Rapidminerlogo.png}
...
\includegraphics{images/QGISlogo.png} QGIS is a really nice open source
tool for working with geospatial data. To get started just head over to
\url{http://www.qgis.org/en/site/index.html}

\subsection{Github}\label{github}

\includegraphics{images/GithubEdulogo.png}
...
\includegraphics{images/diigologo.png}
...
\includegraphics{images/Reviewlogo.png}
...
\tightlist
\item
  \textbf{UTS Online:} UTS' Online learning system
\item
  \textbf{CICAround:} CIC's blog environment where students can post
  blogs about their studies and learning
\item
  \textbf{FlipAround:} A student guide developed by students for
  students in a collaborative environment
\item
  \textbf{R:} A coding language used in data science
\item
  \textbf{Python:} A coding language used in data science
\item
  \textbf{KNIME:} A algorithm building tool
\item
  \textbf{Diigo:} A collection of resources contributed by the MDSI
  community
\item
  \textbf{Slack:} A `chat' type application completely driven by the
  student community.
\item
  \textbf{WordPress:} The host of CICAround
\item
  \textbf{Lynda.com:} An online learning platform with many free courses
\item
  \textbf{MOOC:} Massive Open Online Course
\item
  \textbf{Hackathon:} an event, typically lasting several days, in which
  a large number of people meet to engage in collaborative computer
  programming to find information in data
\item
  \textbf{Azure:} Microsoft's cloud computing platform
\item
  \textbf{AWS:} Amazon Web Services' cloud computing services
\item
  \textbf{Coursera:} Website host/ service provider of MOOC's
\item
  \textbf{GA:} Graduate Attribute
\item
  \textbf{CILO:} Course Intended Learning Outcome
\item
  \textbf{SILO:} Subject Intended Learning Outcome
\end{itemize}
